...
namespace Study_ado.Models {
    ...
    public partial class StudyDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public StudentsRow AddStudentsRow(string name, string surname, bool sex, System.DateTime birthday) {
...
namespace Study_ado.Models.StudyDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Students] WHERE (([studentId] = @Original_studentId) AND ([name] = @Original_name) AND ([surname] = @Original_surname) AND ((@IsNull_sex = 1 AND [sex] IS NULL) OR ([sex] = @Original_sex)) AND ((@IsNull_birthday = 1 AND [birthday] IS NULL) OR ([birthday] = @Original_birthday)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([name], [surname], [sex], [birthday]) VALUES (@name" +
                ", @surname, @sex, @birthday);\r\nSELECT studentId, name, surname, sex, birthday FR" +
                "OM Students WHERE (studentId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [name] = @name, [surname] = @surname, [sex] = @sex, [birthday] = @birthday WHERE (([studentId] = @Original_studentId) AND ([name] = @Original_name) AND ([surname] = @Original_surname) AND ((@IsNull_sex = 1 AND [sex] IS NULL) OR ([sex] = @Original_sex)) AND ((@IsNull_birthday = 1 AND [birthday] IS NULL) OR ([birthday] = @Original_birthday)));
SELECT studentId, name, surname, sex, birthday FROM Students WHERE (studentId = @studentId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Study_ado.Properties.Settings.Default.StudyConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT studentId, name, surname, sex, birthday FROM dbo.Students";
        ...
        public virtual int Fill(StudyDataSet.StudentsDataTable dataTable) {
        ...
        public virtual StudyDataSet.StudentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudyDataSet.StudentsDataTable dataTable = new StudyDataSet.StudentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudyDataSet.StudentsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_studentId, string Original_name, string Original_surname, global::System.Nullable<bool> Original_sex, global::System.Nullable<global::System.DateTime> Original_birthday) {
        ...
        public virtual int Insert(string name, string surname, global::System.Nullable<bool> sex, global::System.Nullable<global::System.DateTime> birthday) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string surname, global::System.Nullable<bool> sex, global::System.Nullable<global::System.DateTime> birthday, int Original_studentId, string Original_name, string Original_surname, global::System.Nullable<bool> Original_sex, global::System.Nullable<global::System.DateTime> Original_birthday, int studentId) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
            ...
            if ((Original_sex.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((bool)(Original_sex.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string surname, global::System.Nullable<bool> sex, global::System.Nullable<global::System.DateTime> birthday, int Original_studentId, string Original_name, string Original_surname, global::System.Nullable<bool> Original_sex, global::System.Nullable<global::System.DateTime> Original_birthday) {
            return this.Update(name, surname, sex, birthday, Original_studentId, Original_name, Original_surname, Original_sex, Original_birthday, Original_studentId);
        }
    }
